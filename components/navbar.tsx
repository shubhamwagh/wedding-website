...
export default function Navbar({ isFixed }: { isFixed: boolean }) {
  return (
    ...
    >
      <nav
        className={cn(
          'flex w-full snap-x items-center justify-between gap-4 overflow-x-auto whitespace-nowrap px-4 py-0 text-gold font-bold lg:justify-center lg:gap-12',
          isFixed &&
            'rounded-full bg-white/50 text-sm text-gray ring-1 ring-light-gold/50 backdrop-blur-md',
        )}
      >
